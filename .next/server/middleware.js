...
var dist = __webpack_require__(637);
...
async function middleware(req) {
    ...
    const isProtectedRoute = hostRoutes.some((route)=>req.nextUrl.pathname.startsWith(route));
    if (isProtectedRoute) {
        // Create authenticated Supabase client
        const res = NextResponse.next();
        const supabase = (0,dist.createServerSupabaseClient)({
            req,
            res
        });
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5CeddiePC%5CDesktop%5CGuestify%5CGuestify&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2hvc3QoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9ob3N0LzpwYXRoKiJ9XQ%3D%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2hvc3QoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9ob3N0LzpwYXRoKiJ9XX0%3D!
...
var import_auth_helpers_shared = __webpack_require__(911);
var supabase;
...
var import_auth_helpers_shared2 = __webpack_require__(911);
var import_set_cookie_parser = __webpack_require__(805);
...
var import_auth_helpers_shared3 = __webpack_require__(911);
var import_set_cookie_parser2 = __webpack_require__(805);
...
var import_auth_helpers_shared4 = __webpack_require__(911);
...
var import_auth_helpers_shared5 = __webpack_require__(911);
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(61));
const PostgrestError_1 = __importDefault(__webpack_require__(255));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(220));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(217));
const constants_1 = __webpack_require__(262);
/**
 * PostgREST client.
 *
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(901));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(314));
...
const version_1 = __webpack_require__(128);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(260));
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 61)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var cjs = __webpack_require__(177);
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 745, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 61))).Response;
        }
        return Response;
    });
